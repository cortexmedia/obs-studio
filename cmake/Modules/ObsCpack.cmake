...
set(CPACK_PACKAGE_NAME "OBS|DaCast")
set(CPACK_PACKAGE_VENDOR "dacast.com")
...
if(INSTALLER_RUN)
	set(CPACK_PACKAGE_EXECUTABLES
		"obs32" "OBS Studio - DaCast (32bit)"
		"obs64" "OBS Studio - DaCast (64bit)")
	...
	set(CPACK_PACKAGE_EXECUTABLES "obs${_output_suffix}" "OBS Studio - DaCast")
	set(CPACK_CREATE_DESKTOP_LINKS "obs${_output_suffix}")
endif()

set(CPACK_BUNDLE_NAME "OBS|DaCast")
...
if(INSTALLER_RUN)
	set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY "OBSStudioDaCast")
...
elseif(CMAKE_SIZEOF_VOID_P EQUAL 8)
	if(WIN32)
		set(CPACK_PACKAGE_NAME "OBS Studio - DaCast (64bit)")
	endif()
	set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY "OBSStudioDaCast64")
	...
	if(WIN32)
		set(CPACK_PACKAGE_NAME "OBS Studio - DaCast (32bit)")
	endif()
	set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY "OBSStudioDaCast32")
